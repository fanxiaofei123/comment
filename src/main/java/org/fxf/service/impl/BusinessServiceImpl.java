...
import org.fxf.constant.CategoryConst;
import org.fxf.dao.BusinessDao;
...
public class BusinessServiceImpl implements BusinessService{
	...
	public boolean modify(BusinessDto businessDto) {
		...
		if (businessDto.getImgFile() != null && businessDto.getImgFile().getSize() > 0) {
			//删除原来的图片
			FileUtil.delete(businessImageSavePath + businessDao.selectById(business.getId()).getImgFileName());
